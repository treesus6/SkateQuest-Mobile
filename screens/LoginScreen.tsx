        ...
        >
          <View style={s.poster}>
            ...
            <View style={s.posterStats}>
              <View style={s.posterStat}><MapPin color={PAPER} size={14} /><Text style={s.posterStatText}>REAL SPOTS</Text></View>
              <View style={s.posterStat}><Target color={PAPER} size={14} /><Text style={s.posterStatText}>REAL QUESTS</Text></View>
              <View style={s.posterStat}><Play color={PAPER} fill={PAPER} size={13} /><Text style={s.posterStatText}>REAL CLIPS</Text></View>
            </View>
          </View>
          ...
          <View style={s.formSheet}>
            <View style={s.formHeadingRow}>
              ...
              <View style={s.formNumber}><Text style={s.formNumberText}>01</Text></View>
            </View>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <View style={s.loginArrow}><ArrowRight color={INK} size={19} strokeWidth={3} /></View>
                </>
              )}
            </Pressable>
...
const s = StyleSheet.create({
  ...
  poster: { height: 330, margin: 14, marginBottom: 0, borderRadius: 30, overflow: 'hidden', backgroundColor: '#11141A', borderWidth: 1, borderColor: '#2A2E36', position: 'relative' },
  posterOrange: { position: 'absolute', width: 270, height: 94, right: -90, top: 24, backgroundColor: ORANGE, transform: [{ rotate: '34deg' }] },
  posterAcid: { position: 'absolute', width: 230, height: 28, left: -88, bottom: 66, backgroundColor: ACID, transform: [{ rotate: '-12deg' }] },
  posterBlue: { position: 'absolute', width: 100, height: 100, borderRadius: 50, right: 24, bottom: 16, backgroundColor: BLUE, opacity: 0.2 },
  ...
  liveTag: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(0,0,0,0.58)', paddingHorizontal: 9, minHeight: 31, borderRadius: 999, borderWidth: 1, borderColor: 'rgba(255,255,255,0.16)' },
  ...
  posterLine: { color: ORANGE, fontSize: 11, fontWeight: '900', letterSpacing: 1.45, marginTop: 14 },
  posterStats: { flexDirection: 'row', gap: 7, padding: 18, paddingTop: 0 },
  posterStat: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: 'rgba(0,0,0,0.48)', borderRadius: 10, paddingHorizontal: 8, minHeight: 31, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  posterStatText: { color: PAPER, fontSize: 7.5, fontWeight: '900', letterSpacing: 0.65 },

  formSheet: { marginTop: -9, marginHorizontal: 14, backgroundColor: PAPER, borderRadius: 27, padding: 19, borderWidth: 2, borderColor: INK, shadowColor: '#000', shadowOpacity: 0.28, shadowRadius: 12, shadowOffset: { width: 0, height: 8 }, elevation: 6 },
  formHeadingRow: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 3 },
  ...
  formNumber: { width: 42, height: 42, borderRadius: 13, backgroundColor: ORANGE, alignItems: 'center', justifyContent: 'center', transform: [{ rotate: '5deg' }] },
  ...
  errorBox: { backgroundColor: '#FFE5E1', borderRadius: 13, padding: 12, marginBottom: 13, borderWidth: 1, borderColor: '#E36D3F' },
  ...
  loginBtn: { minHeight: 55, backgroundColor: ACID, borderRadius: 15, borderWidth: 2, borderColor: INK, paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 4, transform: [{ rotate: '-0.5deg' }] },
  loginTxt: { color: INK, fontWeight: '900', fontSize: 15, letterSpacing: 0.5 },
  loginArrow: { width: 34, height: 34, borderRadius: 11, backgroundColor: ORANGE, alignItems: 'center', justifyContent: 'center' },
  btnDis: { opacity: 0.5 },
  ...
  googleBtn: { minHeight: 53, backgroundColor: INK, borderRadius: 15, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, borderWidth: 2, borderColor: INK },
  googleMark: { width: 27, height: 27, borderRadius: 9, backgroundColor: PAPER, alignItems: 'center', justifyContent: 'center' },
